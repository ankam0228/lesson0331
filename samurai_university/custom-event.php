                    ...
                    <div class="news_posts_small">
                      <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sx-12">
                          ...
                          <img src="<?php ech get_template_directory_url( );?>/images/tags-solid.png" alt=""/>イベント
                          </div>
                          ...
                          <div class="news_time">
                            <div>
                              <img src="<?php echo get_template_directory_url(); ?>/images/clock-regular.png" alt=""/>
                              <span>日付：<?php echo post_custom('date') ?></span>
                            </div>
                            <div>
                              <img src="<?php echo get_template_directory_url();?>/images/yen-sign-solid.png" alt=""/>
                          ...
                          <img src="<?php echo get_template_directory_url(); ?>/images/facebook-square-brands.png" alt=""/>
